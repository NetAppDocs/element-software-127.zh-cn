...
* > 1.00 ：客户端正在利用的限制超过 maxIOPS 设置的限制。如果 burstIOPS QoS 设置高于 maxIOPS ，则可以执行此操作。例如、如果maxIOPS设置为1000、burstIOPS设置为2000、则在客户端充分利用卷的情况下、该 `volumeUtilization`值将为2.00。
