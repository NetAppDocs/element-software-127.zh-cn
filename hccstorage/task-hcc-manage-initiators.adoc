...
[role="lead"]
您可以使用link:../concepts/concept_solidfire_concepts_initiators.html["启动程序"]对卷进行基于CHAP的访问、而不是基于帐户的访问。您可以创建和删除启动程序，并为其提供友好的别名，以简化管理和卷访问。将启动程序添加到卷访问组时，该启动程序将允许访问组中的所有卷。
...
.关于此任务
可接受的启动程序IQN格式是 `iqn.yyyy-mm`，y和m是数字，后跟文本，该文本只能包含数字、小写字母字符、句点(`.`()、冒号()(`:`或短划线)(`-`。格式示例如下：

[listing]
----
iqn.2010-01.com.solidfire:c2r9.fc0.2100000e1e09bb8b
----
可接受的光纤通道启动程序WWPN格式为 `:Aa:bB:CC:dd:11:22:33:44`或 `AabBCCdd11223344`。格式示例如下：
